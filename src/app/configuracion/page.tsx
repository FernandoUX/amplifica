...
import { Settings01, Monitor01, User01, Bell01 } from "@untitled-ui/icons-react";
...
const TABS: { key: Tab; label: string; shortLabel: string; icon: React.ComponentType<{ className?: string }> }[] = [
  { key: "general",         label: "General",         shortLabel: "General",   icon: Settings01 },
  { key: "visualizacion",   label: "Visualización",   shortLabel: "Visual",    icon: Monitor01 },
  { key: "cuenta",          label: "Cuenta",          shortLabel: "Cuenta",    icon: User01 },
  { key: "notificaciones",  label: "Notificaciones",  shortLabel: "Notif.",    icon: Bell01 },
];
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-neutral-100 flex items-center justify-center">
            <Settings01 className="w-5 h-5 text-neutral-600" />
          </div>
          <div>
